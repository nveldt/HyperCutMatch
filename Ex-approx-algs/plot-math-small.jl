...
s1 = 300
s2 = 225
f = plot(title = "",grid = false,legend = :false, xlabel = "n", ylabel = "Approx Ratio")
scatter!(f,N,approx_cm[:,1],markerstrokewidth = 0, label = "HCM-1", size = (s1,s2),color = c1)
scatter!(f,N,approx_cm[:,3],markerstrokewidth = 0, label = "HCM-2", size = (s1,s2),color = c2)
...
scatter!(f,N,runs_cm[:,3],markerstrokewidth = 0, label = "HCM-2", size = (s1,s2),color = c2)
...
scatter!(f,Mu,approx_cm[:,3],markerstrokewidth = 0, label = "HCM-2", size = (s1,s2),color = c2)
...
scatter!(f,Mu,runs_cm[:,3],markerstrokewidth = 0, label = "HCM-2", size = (s1,s2),color = c2)
