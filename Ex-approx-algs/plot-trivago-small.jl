...
s1 = 300
s2 = 225
f = plot(title = "",grid = false,legend = :bottomright, xlabel = "n", ylabel = "Approximation Ratio")
...
savefig("Figures/trivago-small-approx.pdf")
...
savefig("Figures/trivago-small-runtimes.pdf")
...
scatter!(f,Mu_sdp,ba_sdp,markerstrokewidth = 0, label = "SDP",color = c4)
# savefig("Figures/trivago-small-approx-mu.pdf")
...
# savefig("Figures/trivago-small-runtimes-mu.pdf")
